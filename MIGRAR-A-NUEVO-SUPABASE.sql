...
-- ############################################################################
-- [EXTRA 1] RESTAURAR TRIGGERS (arreglo del 22/09/2026)
-- ----------------------------------------------------------------------------
-- Un `DROP TRIGGER` sin recrear (en la migración de "duplicados") dejaba la
-- base sin estos seis triggers: la huella de respuestas_rapidas (error
-- «null value in column "huella" ... violates not-null constraint» al
-- sincronizar), las marcas de la ventana de 24 h, los no leídos, el enrutado
-- por número y la marca de atendido. Este bloque los recrea y recalcula las
-- marcas viejas. Es idempotente.
-- ############################################################################
-- ============================================================================
...
-- ############################################################################
-- [EXTRA 2] FECHA DE ENTRADA A LA ETAPA (recordatorios de «No contesta»)
-- ############################################################################
-- ============================================================================
