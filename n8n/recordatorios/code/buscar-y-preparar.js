...
//   4. Credenciales por variables de entorno de n8n, con respaldo escrito aquí.
//      Cambiar de proyecto Supabase = solo actualizar SUPABASE_URL y
//      SUPABASE_SERVICE_ROLE_KEY (en el entorno o en este nodo); ya no hay que
//      tocar tres nodos distintos.
// ============================================================================
...
const env = (clave, respaldo) => {
  try {
    ...
    // Esta instancia de n8n puede tener bloqueado el acceso a variables de entorno.
    return respaldo;
  }
};
